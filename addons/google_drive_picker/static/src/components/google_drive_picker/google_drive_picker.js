...
'use strict';
    ...
    const CustomAttachmentBox = patchMixin(require('attachments_manager/static/src/components/attachment_box_custom/attachment_box_custom.js'));
    ...
    CustomAttachmentBox.patch('attachments_manager.picker_gdrive', T => class extends T {
        ...
        createPicker() {
            ...
            if (this.gdrive.pickerApiLoaded && this.gdrive.oauthToken) {
                ...
                //this._rpc({
                    ...
                    if (drive_path) {
                        picker.addView(new google.picker.DocsView().setParent(drive_path))
                        picker.addView(new google.picker.DocsUploadView().setParent(drive_path).setIncludeFolders(true))
                    }
                    else{
